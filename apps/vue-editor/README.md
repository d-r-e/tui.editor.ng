...
[![npm version](https://img.shields.io/npm/v/@darodrig/vue-editor-ng.svg)](https://www.npmjs.com/package/@darodrig/vue-editor-ng)
...
```sh
npm install --save @darodrig/vue-editor-ng
```
...
You can use Toast UI Editor for Vue as a ECMAScript module or a CommonJS module. As this module does not contain CSS files, you should import `toastui-editor.css` from `@darodrig/tui-editor-ng` in the script.
...
import { Editor } from '@darodrig/vue-editor-ng';
```
...
const { Editor } = require('@darodrig/vue-editor-ng');
```
...
```js
import '@darodrig/tui-editor-ng/dist/toastui-editor-viewer.css';

import { Viewer } from '@darodrig/vue-editor-ng';
```

- CommonJS

```js
require('@darodrig/tui-editor-ng/dist/toastui-editor-viewer.css');

const { Viewer } = require('@darodrig/vue-editor-ng');
```
